...
!function(jsCommon) {
    ...
    !function(DOMConstants) {
        ...
        DOMConstants.disabledAttributeOrValue = "disabled", DOMConstants.readonlyAttributeOrValue = "readonly", 
        DOMConstants.idAttribute = "id", DOMConstants.styleAttribute = "style", DOMConstants.hrefAttribute = "href", 
        DOMConstants.targetAttribute = "target", DOMConstants.blankValue = "_blank", DOMConstants.selfValue = "_self", 
        DOMConstants.classAttribute = "class", DOMConstants.titleAttribute = "title", DOMConstants.srcAttribute = "src", 
        DOMConstants.contextmenuEventName = "contextmenu", DOMConstants.blurEventName = "blur", 
        DOMConstants.keyUpEventName = "keyup", DOMConstants.inputEventName = "input", DOMConstants.changeEventName = "change", 
        DOMConstants.cutEventName = "cut", DOMConstants.keyDownEventName = "keydown", DOMConstants.mouseMoveEventName = "mousemove", 
        DOMConstants.mouseDownEventName = "mousedown", DOMConstants.mouseEnterEventName = "mouseenter", 
        DOMConstants.mouseLeaveEventName = "mouseleave", DOMConstants.mouseOverEventName = "mouseover", 
        DOMConstants.mouseOutEventName = "mouseout", DOMConstants.mouseClickEventName = "click", 
        DOMConstants.pasteEventName = "paste", DOMConstants.scrollEventName = "scroll", 
        DOMConstants.dropEventName = "drop", DOMConstants.focusEventName = "focus", DOMConstants.focusInEventName = "focusin", 
        DOMConstants.focusOutEventName = "focusout", DOMConstants.selectEventName = "select", 
        DOMConstants.messageEventName = "message", DOMConstants.loadEventName = "load", 
        DOMConstants.beforeUnload = "beforeunload", DOMConstants.inputAndSelectEventNames = "input, select";
    ...
    var PowerBIErrorDetailHelper = function() {
        ...
        return PowerBIErrorDetailHelper.addAdditionalInfo = function(errorDetails, pbiErrorDetails, localize) {
            if (pbiErrorDetails) for (var i = 0; i < pbiErrorDetails.length; i++) {
                var element = pbiErrorDetails[i], localizedCode = localize.get(PowerBIErrorDetailHelper.serverErrorPrefix + element.code), additionErrorInfoKeyValuePair = {
...
if (function(powerbi) {
    ...
    var EnglishBackup = {
        ...
        return GeoTaggingAnalyzerService.prototype.isLongitudeOrLatitude = function(fieldRefName) {
            ...
            return GeoTaggingAnalyzerService.hasMatches(fieldRefName, [ EnglishBackup.GeotaggingString_Longitude, EnglishBackup.GeotaggingString_Longitude_Short ]);
        }, GeoTaggingAnalyzerService.prototype.isEnglishLatitude = function(fieldRefName) {
            return GeoTaggingAnalyzerService.hasMatches(fieldRefName, [ EnglishBackup.GeotaggingString_Latitude, EnglishBackup.GeotaggingString_Latitude_Short ]);
...
!function(jsCommon) {
    ...
    !function(ArrayExtensions) {
        ...
        ArrayExtensions.indexWithName = indexWithName, ArrayExtensions.clear = clear, ArrayExtensions.isUndefinedOrEmpty = isUndefinedOrEmpty, 
        ArrayExtensions.swap = swap, ArrayExtensions.isInArray = isInArray;
...
!function(jsCommon) {
    ...
    !function(WordBreaker) {
        ...
        function getMaxWordWidth(content, textWidthMeasurer, properties) {
            for (var words = split(content), maxWidth = 0, _i = 0; _i < words.length; _i++) {
                var w = words[_i];
        ...
        function splitByWidth(content, properties, textWidthMeasurer, maxWidth, maxNumLines, truncator) {
            ...
            for (var result = [], words = split(content), usedWidth = 0, wordsInLine = [], _i = 0; _i < words.length; _i++) {
                var word = words[_i];
    ...
    !function(TextMeasurementService) {
        ...
        function estimateSvgTextRect(textProperties) {
            ...
            if (null == rect) {
                ...
                rect = measureSvgTextRect(estimatedTextProperties), rect.height > 0 && powerbi.ephemeralStorageService.setData(propertiesKey, rect);
            }
            return rect;
        }
...
!function(jsCommon) {
    ...
    !function(StringExtensions) {
        ...
        function ensureUniqueNames(names) {
            for (var usedNames = {}, _i = 0; _i < names.length; _i++) {
                var name_1 = names[_i];
                usedNames[name_1] = !1;
            }
            for (var uniqueNames = [], _a = 0; _a < names.length; _a++) {
                var name_2 = names[_a], uniqueName = name_2;
...
!function(jsCommon) {
    ...
    !function(UrlUtils) {
        ...
        var urlRegex = /http[s]?:\/\/(\S)+/gi, imageUrlRegex = /http[s]?:\/\/(\S)+(png|jpg|jpeg|gif|svg)/gi;
